...
public class CassandraTest {
    ...
    @Test
    public void testParseRepilcaWithSimpleStrategyEmptyReplica() {
        String strategy = CassandraOptions.CASSANDRA_STRATEGY.name();
        String replica = CassandraOptions.CASSANDRA_REPLICATION.name();
    ...
    @Test
    public void testParseRepilcaWithSimpleStrategyDoubleReplica() {
        String strategy = CassandraOptions.CASSANDRA_STRATEGY.name();
        String replica = CassandraOptions.CASSANDRA_REPLICATION.name();
    ...
    @Test
    public void testParseRepilcaWithSimpleStrategyStringReplica() {
        String strategy = CassandraOptions.CASSANDRA_STRATEGY.name();
        String replica = CassandraOptions.CASSANDRA_REPLICATION.name();
        ...
        Mockito.when(conf.getProperty(strategy))
               .thenReturn("SimpleStrategy");
        Mockito.when(conf.getProperty(replica))
               .thenReturn(ImmutableList.of("xxx"));
        HugeConfig config = new HugeConfig(conf);
    ...
    @Test
    public void testParseRepilcaWithNetworkTopologyStrategyStringReplica() {
        String strategy = CassandraOptions.CASSANDRA_STRATEGY.name();
        String replica = CassandraOptions.CASSANDRA_REPLICATION.name();
        ...
        Mockito.when(conf.getProperty(strategy))
               .thenReturn("NetworkTopologyStrategy");
        Mockito.when(conf.getProperty(replica))
               .thenReturn(ImmutableList.of("dc1:2", "dc2:x"));
        HugeConfig config = new HugeConfig(conf);
    ...
    @Test
    public void testParseRepilcaWithNetworkTopologyStrategyEmptyDatacenter() {
        String strategy = CassandraOptions.CASSANDRA_STRATEGY.name();
        String replica = CassandraOptions.CASSANDRA_REPLICATION.name();
    ...
    @Test
    public void testParseRepilcaWithNetworkTopologyStrategyEmptyReplica() {
        String strategy = CassandraOptions.CASSANDRA_STRATEGY.name();
        String replica = CassandraOptions.CASSANDRA_REPLICATION.name();
    ...
    @Test
    public void testParseRepilcaWithNetworkTopologyStrategyDoubleReplica() {
        String strategy = CassandraOptions.CASSANDRA_STRATEGY.name();
        String replica = CassandraOptions.CASSANDRA_REPLICATION.name();
